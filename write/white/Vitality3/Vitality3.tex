...
Our approach is synthetic and multidisciplinary: we bring together developmental psychology, developmental robotics, and formal mathematics not as separate contributions but as mutually constraining disciplines. Accurate descriptions of how organisms develop guide the construction of artificial agents---and the successes and failures of those constructions test the descriptions. This creative scientific style is visualized in Figure~\ref{fig:describe-build}.
...
\subsection{Mechanizing Play as Vitality}
